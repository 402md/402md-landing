const LINKEDIN = 'https://www.linkedin.com/in/henrique-breim/';
const X = 'https://x.com/_breim';

export function Footer({ index = 0 }: { index?: number }) {
  return (
    <footer
    ...
    >
      ...
      <div className="footer-social">
        <a
          ...
          aria-label="Henrique Breim on LinkedIn"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Henrique Breim on X"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
